        ...
        <div class="conteudo">
            ...
            <div class="modulo roxo">
                ...
                <ul>
                    ...
                    <li><a href="exercicio.php?dir=controle&file=testes_if_else">Projeto Luz (Teste)</a></li>
                    <li><a href="exercicio.php?dir=controle&file=tabela_futebol">Projeto Tabela Futebol (Teste)</a></li>
                </ul>
            </div>
            ...
            <div class="modulo vermelho">
                <h3>2. Tipos</h3>
                    <ul>
                        ...
                        <li><a href="exercicio.php?dir=tipos&file=aritmeticos">Operações Aritméticas</a></li>
                        <li><a href="exercicio.php?dir=tipos&file=desafio_precedencia">Desafio Precedêndia</a></li>
